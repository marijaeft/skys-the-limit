...
import HogwPlanner from "../assets/hogw.webp"
import HogwPlannerBanner from "../assets/hogw-banner.webp"
import HogwPlannerImg1 from "../assets/hogw-1.webp"
import HogwPlannerImg2 from "../assets/hogw-2.webp"
import HogwPlannerImg3 from "../assets/hogw-3.webp"

import SkysBluePlanner from "../assets/skys-blue.webp"
import SkysBluelannerBanner from "../assets/skys-blue-banner.webp"
import SkysBluePlannerImg1 from "../assets/skys-blue-1.webp"
import SkysHarmonyPlanner from "../assets/skys-harmony.webp"
import SkysHarmonyPlannerBanner from "../assets/skys-harmony-banner.webp"
import SkysHarmonyPlannerImg1 from "../assets/skys-harmony-1.webp"
import SkysPlannerImg2 from "../assets/skys-2.webp"
import SkysPlannerImg3 from "../assets/skys-3.webp"
...
const planners = [
    ...
    },
    {
        ...
        subtitle: "Магичен дневник за планирање, организирање и личен развој!",
        characteristics: [
            "A5 формат",
            "204 страни",
            "Тврди корици",
        ...
        content: [
            "Календар за 2026",
            "Поставување на долгорочни цели",
            "Листа на прочитани книги, шопинг листа за книги и место за омилени цитати",
            "Годишен предизвик: ‘Заштеди секој ден од годината одредена сума на пари’",
            "Годишен предизвик: ‘Секој ден физичка активност’",
            "Поставување месечни цели",
            "Неделен приказ (+ оброци, внес на вода, тренинг, белешки) (x60)",
            "Месечен буџет (x12)",
            "Месечно следење на нови навики (x12)",
            "Месечна рефлексија (x12)",
            "Пола страна шема од точки за дополнителна организација (x12)",
            "Благодарност (x12)",
            "Страници за анксиозност",
            "5,4,3,2,1 метод за смирување",
            "Страници за самодоверба, самопочитување, животен баланс, грижи, манифестирање, позитивни афирмации",
            "Прашања за длабока лична рефлексија",
            "Инструкции за полесно пополнување",
            "План за патување (x2)",
            "Brain dump (x4)",
    ...
    },
    {
        ...
        content: [
            "Календар за 2026",
            "Поставување на долгорочни цели",
            "Запишување на лозинки и контакти",
            "Листа на прочитани книги, шопинг листа за книги и место за запишување омилени цитати",
            "Дневник на моето здравје",
            "Годишен предизвик: ‘Заштеди секој ден од годината одредена сума на пари’",
            "Годишен предизвик: ‘Секој ден физичка активност’",
            "Поставување месечни цели",
            "Неделен приказ (+ оброци, внес на вода, тренинг, белешки) (x60)",
            ...
            "Месечно следење на нови навики (x12)",
            "Месечна рефлексија (x12)",
            "Пола страна шема од точки за да запишете/организирате нешто дополнително доколку е потребно (x12)",
            "Благодарност (x12)",
            "Страници за анксиозност",
            "5,4,3,2,1 метод за смирување",
            "Страници за самодоверба, самопочитување, животен баланс, грижи, благодарност, повторно откривање на себе, манифестирање, позитивни афирмации, рецепт за среќа",
            "30 дена - предизвик за здрави навики",
            "Кои се вашите желби, а што навистина ви треба",
            "Работи кои би сакале да ги направите пред вашиот роденден",
            "Накити ја елката со твоите најголеми достигнувања",
            "Кој е твојот живот од соништата и што е тоа што те кочи",
            "Страници со различни прашања кои навистина ќе ве натераат да размислите",
            "Инструкции кои ќе ви помогнат да ги пополните страните",
            "План за патување (x2)",
            "Brain dump (x4)",
            "Секојдневно следење и боење на чувства (Mood Tracker)",
            "Преслатки стикери на крајот од дневникот"
        ],
        bannerImg: SkysBluelannerBanner,
        cardImage: SkysBluePlanner,
        images:
            [
                SkysBluePlannerImg1,
                SkysPlannerImg2,
    ...
    },
    {
        ...
        bannerImg: SkysHarmonyPlannerBanner,
        cardImage: SkysHarmonyPlanner,
        images:
            [
                SkysHarmonyPlannerImg1,
                SkysPlannerImg2,
                SkysPlannerImg3
            ],
        price: "1100 ден",
